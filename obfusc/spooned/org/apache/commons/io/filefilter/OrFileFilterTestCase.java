...
public class OrFileFilterTestCase extends org.apache.commons.io.filefilter.ConditionalFileFilterAbstractTestCase {
    private static final java.lang.String DEFAULT_WORKING_PATH = "./OrFileFilterTestCase/";

    private static final java.lang.String WORKING_PATH_NAME_PROPERTY_KEY = (org.apache.commons.io.filefilter.OrFileFilterTestCase.class.getName()) + ".workingDirectory";
    ...
    public OrFileFilterTestCase(final java.lang.String name) {
        super(name);
    }
    ...
    protected org.apache.commons.io.filefilter.IOFileFilter a(final java.util.List<org.apache.commons.io.filefilter.IOFileFilter> filters) {
        final org.apache.commons.io.filefilter.OrFileFilter filter = new org.apache.commons.io.filefilter.OrFileFilter();
    ...
    @java.lang.Override
    protected org.apache.commons.io.filefilter.ConditionalFileFilter h() {
    ...
    @java.lang.Override
    protected java.util.List<boolean[]> c() {
        return this.testFalseResults;
    }

    @java.lang.Override
    protected java.util.List<java.lang.Boolean> d() {
    ...
    @java.lang.Override
    protected java.util.List<java.util.List<org.apache.commons.io.filefilter.IOFileFilter>> f() {
        return this.testFilters;
    }

    @java.lang.Override
    protected java.util.List<boolean[]> g() {
    ...
    private void a() {
        ...
        }
        {
            ...
            testFileResults.add(2, java.lang.Boolean.TRUE);
            testFilenameResults.add(2, java.lang.Boolean.TRUE);
        }
        {
            final java.util.List<org.apache.commons.io.filefilter.IOFileFilter> filters = new java.util.ArrayList<org.apache.commons.io.filefilter.IOFileFilter>();
            filters.add(trueFilters[1]);
            ...
            testFileResults.add(3, java.lang.Boolean.TRUE);
            testFilenameResults.add(3, java.lang.Boolean.TRUE);
        }
        {
            final java.util.List<org.apache.commons.io.filefilter.IOFileFilter> filters = new java.util.ArrayList<org.apache.commons.io.filefilter.IOFileFilter>();
            filters.add(trueFilters[1]);
            ...
            testFileResults.add(4, java.lang.Boolean.TRUE);
            testFilenameResults.add(4, java.lang.Boolean.TRUE);
        }
        {
            final java.util.List<org.apache.commons.io.filefilter.IOFileFilter> filters = new java.util.ArrayList<org.apache.commons.io.filefilter.IOFileFilter>();
            filters.add(falseFilters[1]);
            ...
            testFileResults.add(5, java.lang.Boolean.TRUE);
            testFilenameResults.add(5, java.lang.Boolean.TRUE);
        }
        {
            final java.util.List<org.apache.commons.io.filefilter.IOFileFilter> filters = new java.util.ArrayList<org.apache.commons.io.filefilter.IOFileFilter>();
            filters.add(trueFilters[1]);
            ...
            testFileResults.add(6, java.lang.Boolean.TRUE);
            testFilenameResults.add(6, java.lang.Boolean.TRUE);
        }
        {
            final java.util.List<org.apache.commons.io.filefilter.IOFileFilter> filters = new java.util.ArrayList<org.apache.commons.io.filefilter.IOFileFilter>();
            filters.add(falseFilters[1]);
            ...
            testFileResults.add(7, java.lang.Boolean.TRUE);
            testFilenameResults.add(7, java.lang.Boolean.TRUE);
        }
        {
            final java.util.List<org.apache.commons.io.filefilter.IOFileFilter> filters = new java.util.ArrayList<org.apache.commons.io.filefilter.IOFileFilter>();
            filters.add(trueFilters[1]);
            ...
            testFileResults.add(8, java.lang.Boolean.TRUE);
            testFilenameResults.add(8, java.lang.Boolean.TRUE);
        }
        {
            final java.util.List<org.apache.commons.io.filefilter.IOFileFilter> filters = new java.util.ArrayList<org.apache.commons.io.filefilter.IOFileFilter>();
            filters.add(falseFilters[1]);
