...
public abstract class IOFileFilterAbstractTestCase extends junit.framework.TestCase {
    ...
    public static void b(final int testNumber, final org.apache.commons.io.filefilter.IOFileFilter filter, final java.io.File file, final boolean expected) throws java.lang.Exception {
    ...
    public static void c(final int testNumber, final org.apache.commons.io.filefilter.IOFileFilter filter, final java.io.File file, final boolean expected) throws java.lang.Exception {
        junit.framework.TestCase.assertEquals(((((((("test " + testNumber) + " Filter(File) ") + (filter.getClass().getName())) + " not ") + expected) + " for ") + file), expected, filter.accept(file));
    ...
    public static void a(final int testNumber, final TesterTrueFileFilter[] filters, final boolean[] invoked) {
        for (int i = 1 ; i < (filters.length) ; i++) {
            junit.framework.TestCase.assertEquals((((("test " + testNumber) + " filter ") + i) + " invoked"), invoked[(i - 1)], filters[i].isInvoked());
        }
    }

    public static void a(final int testNumber, final TesterFalseFileFilter[] filters, final boolean[] invoked) {
        for (int i = 1 ; i < (filters.length) ; i++) {
            junit.framework.TestCase.assertEquals((((("test " + testNumber) + " filter ") + i) + " invoked"), invoked[(i - 1)], filters[i].isInvoked());
        }
    }

    public static java.io.File a(final java.lang.String key, final java.lang.String defaultPath) {
    ...
    public static void a(final TesterFalseFileFilter[] filters) {
    ...
    public static void a(final TesterTrueFileFilter[] filters) {
